...
class SentimentRecommenderModel:
    ...
    ROOT_PATH = "pickle/"
    MODEL_NAME = "xg-boost-final-model.pkl"
    ...
    def __init__(self):
        #self.model = json.load(open(SentimentRecommenderModel.ROOT_PATH + SentimentRecommenderModel.MODEL_NAME,'r',encoding='utf-8',errors='ignore'))
    ...
    def getSentimentRecommendations(self, user):
        if (user in self.user_final_rating.index):
            ...
            print(f"The user {user} doesn't exist")
            return None
